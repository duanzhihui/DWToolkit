...
from airflowupdt.core.validator import DAGValidator
...
@click.group()
@click.version_option(version='0.1.0', prog_name='airflowupdt')
def cli():
    """AirflowUpdt - Airflow DAG 升级工具
...
def upgrade(file_path, target_version, backup, backup_dir, dry_run, output, output_format):
    ...
    示例:
        ...
        airflowupdt upgrade my_dag.py --target-version 3.0 --backup
...
def upgrade_dir(directory, target_version, recursive, backup, backup_dir, dry_run, pattern, output, output_format):
    ...
    示例:
        airflowupdt upgrade-dir /dags/
        airflowupdt upgrade-dir /dags/ --recursive --backup
        airflowupdt upgrade-dir /dags/ --dry-run --pattern "dag_*.py"
    """
    print_banner()
...
def init_config(output):
    ...
    示例:
        ...
        airflowupdt init-config -o config.yml
    """
